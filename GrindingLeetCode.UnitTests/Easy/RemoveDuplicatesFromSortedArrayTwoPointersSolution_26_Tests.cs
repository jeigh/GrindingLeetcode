...
namespace GrindingLeetCode.UnitTests.Easy
{
    ...
    [TestClass]
    public class RemoveDuplicatesFromSortedArrayTwoPointersSolution_26_Tests
    {
        private RemoveDuplicatesFromSortedArrayTwoPointersSolution_26 _solution;

        [TestInitialize]
        public void Initialize()
        {
            _solution = new RemoveDuplicatesFromSortedArrayTwoPointersSolution_26();
        }
